...
export const DownloadIcon = () => (
    ...
    >
        <path
            d="M17 18v1H6v-1h11zm-.5-6.6l-.7-.7-3.8 3.7V4h-1v10.4l-3.8-3.8-.7.7 5 5 5-4.9z"
            fill="white"
        ></path>
    </svg>
);
...
export const FashionBeautyIcon = () => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-9 w-9 md:h-6 md:w-6"
...
export const Add = () => (
    <svg
        ...
        focusable="false"
    >
        <path d="M20 12h-8v8h-1v-8H3v-1h8V3h1v8h8v1z" fill="white"></path>
    </svg>
);
